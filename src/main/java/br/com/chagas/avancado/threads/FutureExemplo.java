...
public class FutureExemplo {
    private static final ExecutorService threadedPool = Executors.newFixedThreadPool(3);

    public static void main(String[] args) {
        Casa casa = new Casa(new Quarto());
        casa.obterAfazeresDaCasa().forEach(atividade -> threadedPool.execute(() -> atividade.realizar()));
...
class Quarto extends Comodo{
    ...
    private  void arrumarGuardaRoupa(){System.out.println("arrumar guarda roupa");}
